...
- **Render engine** (`notes/engine.md`) — a GPU path tracer built progressively from a direct-lighting ray tracer toward full spectral, unbiased global illumination.
