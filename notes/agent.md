...
| Normal sampling | Reads `pathtracer/README.md`'s Normals (shading) AOV: normal-mapped shading normal, not pre-perturbation geometric normal | Surface orientation per point, e.g. edge/silhouette cues for `neural.md`'s visual-cortex stage | `pathtracer/README.md` Normals AOV |
