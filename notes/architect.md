...
*Design overview: how `pathtracer/README.md`, `agent.md`, and `neural.md`'s stages are packaged into
...
|---|---|
| Neural language | Python assumed (`neural.md`'s CNN/transformer/DQN/Hopfield mix reads as a PyTorch stack) but not committed; unlike pathtracer, which settled on C++20/CMake back at its own Phase 0. |
